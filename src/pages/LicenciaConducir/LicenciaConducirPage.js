...
export default function UsuariosPage() {
  ...
  const tituloPage = "Licencias de Conduccion";
  ...
  const { data: usuarios, firstLoading, refreshData } = useFetch(() => obtenerLicenciaConduccionApi());

  const handleEliminar = (idUsuario) => {
    eliminarLicenciaConduccion(idUsuario).then((response) => {
